...
import { useAdminHero } from "@/hooks/useCms";
...
export default function AdminHero() {
  const { data: heroesData, isLoading, save, remove } = useAdminHero();
  const heroes = (heroesData || []) as HeroContent[];
  ...
  async function onSubmit(data: HeroFormData) {
    save.mutate(
      { id: editingHero?.id, values: data as unknown as Record<string, unknown> },
      {
        onSuccess: () => {
