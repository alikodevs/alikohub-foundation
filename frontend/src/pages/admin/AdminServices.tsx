...
import { useAdminServices } from "@/hooks/useCms";
...
export default function AdminServices() {
  const { data: servicesData, isLoading, save, remove } = useAdminServices();
  ...
  async function onSubmit(data: ServiceFormData) {
    save.mutate(
      { id: editingService?.id, values: data as unknown as Record<string, unknown> },
      {
        onSuccess: () => {
