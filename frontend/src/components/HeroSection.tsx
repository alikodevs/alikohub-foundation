...
export function HeroSection() {
  ...
  const ctaPrimaryText = heroContent?.cta_primary_text || heroContent?.ctaPrimaryText || "Partner With Us";
  const ctaSecondaryText = heroContent?.cta_secondary_text || heroContent?.ctaSecondaryText || "View Our Ventures";
